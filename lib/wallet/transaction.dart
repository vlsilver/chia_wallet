...
import 'package:chia_wallet/clvm/serialized_program.dart';
import 'package:chia_wallet/core/bech32.dart';
import 'package:chia_wallet/core/consensus_contants.dart';
import 'package:chia_wallet/core/ec.dart';
import 'package:chia_wallet/util/condition_tool.dart';
import 'package:chia_wallet/util/puzzle_util.dart';
...
class Transaction {
  static SpendBundle generateSignedTransaction({
    ...
    var spendBundle = signCoinSpends(
      ...
      additionalData: ConsensusConstants.AGG_SIG_ME_ADDITIONAL_DATA,
  ...
  static List<CoinSpend> _generateUnsignedTransaction({
    ...
    for (var coin in selectUtxos) {
      ...
      if (primaryAnnouncementHash == null) {
        ...
        Program solution = _makeSolution(
          primaries: primaries,
          amount: amount,
          fee: fee,
